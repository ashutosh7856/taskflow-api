...
CREATE TYPE "public"."invite_scope" AS ENUM('workspace', 'board');--> statement-breakpoint
...
CREATE TABLE "board_members" (
	...
	CONSTRAINT "board_user_unique_idx" UNIQUE("board_id","user_id")
);
--> statement-breakpoint
CREATE TABLE "boards" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
CREATE TABLE "workspace_members" (
	...
	"role" "role" DEFAULT 'member' NOT NULL,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "workspace_user_unique_idx" UNIQUE("workspace_id","user_id")
);
--> statement-breakpoint
...
ALTER TABLE "activity_logs" ADD CONSTRAINT "activity_logs_board_id_boards_id_fk" FOREIGN KEY ("board_id") REFERENCES "public"."boards"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "activity_logs" ADD CONSTRAINT "activity_logs_card_id_cards_id_fk" FOREIGN KEY ("card_id") REFERENCES "public"."cards"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "lists_board_position_idx" ON "lists" USING btree ("board_id","position");
